...
namespace DisasterTracker.DataServices.Migrations
{
    ...
    [Migration("20220517161706_add-country")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CountryDisaster", b =>
                {
                    b.Property<Guid>("CountriesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("DisastersId")
                        .HasColumnType("uuid");

                    b.HasKey("CountriesId", "DisastersId");

                    b.HasIndex("DisastersId");
            ...
            modelBuilder.Entity("CountryDisaster", b =>
                {
                    b.HasOne("DisasterTracker.Data.Country.Country", null)
                        .WithMany()
                        .HasForeignKey("CountriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DisasterTracker.Data.Disaster.Disaster", null)
                        .WithMany()
